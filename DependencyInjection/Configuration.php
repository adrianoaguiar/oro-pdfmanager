...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ->scalarNode('file')->defaultValue('%kernel.root_dir%/../vendor/marellocommerce/oro-pdfmanager/src/Ibnab/Bundle/PmanagerBundle/Lib/tcpdf/tcpdf.php')->end()
            ...
            ->children()
                ->arrayNode('tcpdf')
                    ...
                    ->children()
                        ...
                        ->scalarNode('k_path_url')->defaultValue('%kernel.root_dir%/../vendor/marellocommerce/oro-pdfmanager/src/Ibnab/Bundle/PmanagerBundle/Lib/tcpdf/')->end()
                        ->scalarNode('k_path_main')->defaultValue('%kernel.root_dir%/../vendor/marellocommerce/oro-pdfmanager/src/Ibnab/Bundle/PmanagerBundle/Lib/tcpdf/')->end()
                        ->scalarNode('k_path_fonts')->defaultValue('%kernel.root_dir%/../vendor/marellocommerce/oro-pdfmanager/src/Ibnab/Bundle/PmanagerBundle/Lib/fonts/')->end()
                        ...
                        ->scalarNode('k_path_images')->defaultValue('%kernel.root_dir%/../vendor/marellocommerce/oro-pdfmanager/src/Ibnab/Bundle/PmanagerBundle/Lib/tcpdf/examples/images/')->end()
                        ->scalarNode('k_blank_image')->defaultValue('%kernel.root_dir%/../vendor/marellocommerce/oro-pdfmanager/src/Ibnab/Bundle/PmanagerBundle/Lib/tcpdf/examples/images/_blank.png')->end()
